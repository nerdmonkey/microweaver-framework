...
class GasSensorAdapter(BaseAdapter):
    def __init__(self, pin=32, min_reading=0, max_reading=65535):
        self.pin = pin
    ...
    def setup(self):
        try:
            ...
            print("Failed to setup gas sensor:", e)
            self._adc = None
    ...
    def read(self):
        ...
        try:
            ...
            print("Failed to read gas sensor:", e)
            return None
