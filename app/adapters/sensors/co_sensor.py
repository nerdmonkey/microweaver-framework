...
class CoSensorAdapter(BaseAdapter):
    def __init__(self, pin=35, min_reading=0, max_reading=65535):
        self.pin = pin
    ...
    def setup(self):
        try:
            ...
            print("Failed to setup CO sensor:", e)
            self._adc = None
    ...
    def read(self):
        ...
        try:
            ...
            print("Failed to read CO sensor:", e)
            return None
