...
class Setting:
    def __init__(self, config_path=DEVICE_CONFIG_PATH):
        ...
        self.MQTT_TOPIC_PUB = self._value("mqtt_topic_pub", "command/control/room/light")
        self.MQTT_TOPIC_SUB = self._value("mqtt_topic_sub", "data/sensor/room/temperature")
        ...
        self.WIFI_CONNECT_TIMEOUT_SECONDS = self._int("wifi_connect_timeout_seconds", 20)
